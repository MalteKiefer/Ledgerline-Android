...
open class NotImplementedApi : LedgerlineApi {
    ...
    override suspend fun uploadInit(body: de.ledgerline.app.data.remote.dto.UploadInitRequest): Response<de.ledgerline.app.data.remote.dto.UploadInitResponse> = throw NotImplementedError()
    override suspend fun uploadPart(token: okhttp3.RequestBody, part: okhttp3.RequestBody, chunk: MultipartBody.Part): Response<de.ledgerline.app.data.remote.dto.UploadPartResponse> = throw NotImplementedError()
    override suspend fun uploadComplete(body: de.ledgerline.app.data.remote.dto.UploadCompleteRequest): Response<de.ledgerline.app.data.remote.dto.UploadCompleteResponse> = throw NotImplementedError()
    override suspend fun uploadAbort(body: de.ledgerline.app.data.remote.dto.UploadAbortRequest): Response<Unit> = throw NotImplementedError()
    override suspend fun deleteBlob(blob: String): Response<Unit> = throw NotImplementedError()
    override suspend fun reconcileFiles(body: de.ledgerline.app.data.remote.dto.ReconcileRequest): Response<de.ledgerline.app.data.remote.dto.ReconcileResponse> = throw NotImplementedError()
    override suspend fun reconcileGallery(body: de.ledgerline.app.data.remote.dto.ReconcileRequest): Response<de.ledgerline.app.data.remote.dto.ReconcileResponse> = throw NotImplementedError()
