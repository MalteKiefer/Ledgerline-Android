...
open class NotImplementedApi : LedgerlineApi {
    ...
    override suspend fun galleryGeocode(q: String): retrofit2.Response<de.ledgerline.app.data.remote.dto.GeocodeResponse> = throw NotImplementedError()
        ...
        override suspend fun vaultMembers(vault: String): retrofit2.Response<List<de.ledgerline.app.data.remote.dto.VaultMemberDto>> = throw NotImplementedError()
        override suspend fun resolveRecipient(vault: String, body: de.ledgerline.app.data.remote.dto.ResolveRecipientRequest): retrofit2.Response<de.ledgerline.app.data.remote.dto.ResolvedRecipientDto> = throw NotImplementedError()
        override suspend fun addVaultMember(vault: String, body: de.ledgerline.app.data.remote.dto.AddMemberRequest): retrofit2.Response<Unit> = throw NotImplementedError()
        override suspend fun updateVaultMember(vault: String, member: String, body: de.ledgerline.app.data.remote.dto.UpdateMemberRequest): retrofit2.Response<Unit> = throw NotImplementedError()
        override suspend fun deleteVaultMember(vault: String, member: String): retrofit2.Response<Unit> = throw NotImplementedError()
        override suspend fun rotateVault(vault: String, body: de.ledgerline.app.data.remote.dto.RotateRequest): retrofit2.Response<Unit> = throw NotImplementedError()

        override suspend fun accountExport(): retrofit2.Response<okhttp3.ResponseBody> = throw NotImplementedError()
        override suspend fun deleteAccount(body: de.ledgerline.app.data.remote.dto.DeleteAccountRequest): retrofit2.Response<de.ledgerline.app.data.remote.dto.DeleteAccountResponse> = throw NotImplementedError()
        override suspend fun putLocale(body: de.ledgerline.app.data.remote.dto.LocaleRequest): retrofit2.Response<Unit> = throw NotImplementedError()
        override suspend fun putTheme(body: de.ledgerline.app.data.remote.dto.ThemeRequest): retrofit2.Response<Unit> = throw NotImplementedError()
        override suspend fun twoFactorEnable(): retrofit2.Response<de.ledgerline.app.data.remote.dto.TwoFactorEnabledResponse> = throw NotImplementedError()
        override suspend fun twoFactorQr(): retrofit2.Response<de.ledgerline.app.data.remote.dto.TwoFactorQrResponse> = throw NotImplementedError()
        override suspend fun twoFactorConfirm(body: de.ledgerline.app.data.remote.dto.TwoFactorConfirmRequest): retrofit2.Response<Unit> = throw NotImplementedError()
        override suspend fun twoFactorRecoveryCodes(): retrofit2.Response<de.ledgerline.app.data.remote.dto.RecoveryCodesResponse> = throw NotImplementedError()
        override suspend fun twoFactorRegenerateRecoveryCodes(): retrofit2.Response<de.ledgerline.app.data.remote.dto.RecoveryCodesResponse> = throw NotImplementedError()
